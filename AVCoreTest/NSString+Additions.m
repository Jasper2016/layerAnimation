...
- (NSString*)md5Hash 
{
    return nil;//[NSString md5HexDigest:self];
}
...
-(CGSize)sizeWithFont:(UIFont *)font maxSize:(CGSize)maxSize
{
    ...
    CGRect rect = [self boundingRectWithSize:maxSize
                                       options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading//采用换行模式
...
- (CGSize)heightWithFont:(UIFont*)withFont 
    ...
    CGSize suggestedSize = [self boundingRectWithSize:CGSizeMake(width, FLT_MAX) options:NSStringDrawingUsesLineFragmentOrigin attributes: @{ NSFontAttributeName: withFont} context:nil].size;	
