...
- (id) initWithFrame:(CGRect)frame {
    ...
    if (self)
    {
        ...
        self.waveColor = [[UIColor blueColor] colorWithAlphaComponent:.8];
        self.progressColor = [[UIColor clearColor] colorWithAlphaComponent:1];
...
//    _progressImageView.width = 0;
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        renderedImage = [self renderWaveImageFromAudioAsset:asset];
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            _waveImageView.width = renderedImage.size.width;
            _waveImageView.left =0; // (self.width - renderedImage.size.width) / 2;
            _progressImageView.left = _waveImageView.left;
            _progressImageView.width =  0;
        });
    });
...
- (UIImage*) renderWaveImageFromAudioAsset:(AVURLAsset *)songAsset {
    ...
    NSInteger samplesPerPixel = 130; // pretty enougth for most of ui and fast
