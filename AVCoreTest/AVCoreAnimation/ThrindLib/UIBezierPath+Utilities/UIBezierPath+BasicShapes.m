...
+ (UIBezierPath *)circularShape:(CGRect)originalFrame
{
    ...
    UIBezierPath *cirularPath = [UIBezierPath bezierPathWithArcCenter: CGPointMake(CGRectGetMidX(originalFrame), CGRectGetMidY(originalFrame))
                                                           radius:(CGRectGetWidth(originalFrame))/2
...
+ (UIBezierPath *)bezierPathLine:(CGRect)bounds startAngle:(CGFloat)startAngle endAngle:(CGFloat)endAngle lineWidth:(CGFloat)lineWidth
{
    UIBezierPath *startPath = [UIBezierPath bezierPathWithArcCenter: CGPointMake((CGRectGetWidth(bounds))/2,(CGRectGetWidth(bounds))/2)
    ...
    startPath.lineWidth = lineWidth;
    startPath.lineCapStyle = kCGLineCapRound; //线条拐角
...
+ (UIBezierPath *)regularTriangleShape:(CGRect)bounds
{
...
+ (UIBezierPath *)squareShape:(CGRect)bounds
{
    CGPoint point1 = CGPointMake(0, 0);
    CGPoint point2 = CGPointMake(CGRectGetWidth(bounds),0);
    CGPoint point3 = CGPointMake(CGRectGetWidth(bounds), CGRectGetHeight(bounds));
    CGPoint point4 = CGPointMake(0, CGRectGetHeight(bounds));
...
+(CGPathRef) geometryHStroke:(CGRect)bounds startXOffset:(CGFloat )startXOffset upSlideLength: (CGFloat)slideLength
{
    ...
    [startPath addLineToPoint:CGPointMake(upSlideLength, bounds.size.height/2)];
    
    [startPath addLineToPoint:CGPointMake(upStartLength+upSlideLength, bounds.size.height)];
    
    [startPath addLineToPoint:CGPointMake(upStartLength, bounds.size.height)];
    
    [startPath addLineToPoint:CGPointMake(0, bounds.size.height/2)];
...
+(CGPathRef) geometryVStroke:(CGRect)bounds startXOffset:(CGFloat )startXOffset upSlideLength: (CGFloat)slideLength
{
    UIBezierPath *startPath = [UIBezierPath bezierPath];
    ...
    // Set the starting point of the shape.
    [startPath moveToPoint:CGPointMake(bounds.size.width/2, 0)];
    
    [startPath addLineToPoint:CGPointMake(bounds.size.width ,upStartLength)];
    
    [startPath addLineToPoint:CGPointMake(bounds.size.width, upStartLength+upSlideLength)];
    
    [startPath addLineToPoint:CGPointMake(bounds.size.width/2, upSlideLength)];
    
    [startPath addLineToPoint:CGPointMake(0, upStartLength+upSlideLength)];
    
    [startPath addLineToPoint:CGPointMake(0, upStartLength)];
...
+(CGPathRef) homeVStroke:(CGRect)bounds startXOffset:(CGFloat )startXOffset upSlideLength: (CGFloat)slideLength
{
    ...
    [startPath addLineToPoint:CGPointMake(bounds.size.width, upStartLength+upSlideLength+bounds.size.height)];
    
    [startPath addLineToPoint:CGPointMake(0, upStartLength+upSlideLength+bounds.size.height)];
...
+(UIBezierPath *) chatPopoBorderStroke:(CGRect)bounds dirMode:(NSInteger)dirMode rowOffset:(CGFloat)rowOffset
{
    ...
    CGFloat offset = rowOffset;
    
    switch (dirMode) {
        case 0:
        {
            [startPath moveToPoint:CGPointMake(0, offset)];
            
            [startPath addLineToPoint:CGPointMake(((bounds.size.width/2) -offset)-offset,offset)];
            
            [startPath addLineToPoint:CGPointMake((bounds.size.width/2)-offset, 0)];
            
            [startPath addLineToPoint:CGPointMake(((bounds.size.width/2) +offset)-offset,offset)];
            
            [startPath addLineToPoint:CGPointMake(bounds.size.width-offset, offset)];

            [startPath addLineToPoint:CGPointMake(bounds.size.width-offset, bounds.size.height)];
            
            [startPath addLineToPoint:CGPointMake(0, bounds.size.height)];
        ...
        case 1:
        {
            ...
            [startPath addLineToPoint:CGPointMake(bounds.size.width-offset ,0)];
            
            [startPath addLineToPoint:CGPointMake(bounds.size.width-offset, (bounds.size.height/2)-offset-offset)];
            
            [startPath addLineToPoint:CGPointMake(bounds.size.width, (bounds.size.height/2)-offset)];
            
            [startPath addLineToPoint:CGPointMake(bounds.size.width-offset, (bounds.size.height/2)+offset-offset)];
            
            [startPath addLineToPoint:CGPointMake(bounds.size.width-offset, bounds.size.height-offset)];
            
            [startPath addLineToPoint:CGPointMake(0, bounds.size.height-offset)];
        ...
        case 2:
        {
            ...
            [startPath addLineToPoint:CGPointMake(((bounds.size.width/2) +offset-offset) ,bounds.size.height-offset)];
            
            [startPath addLineToPoint:CGPointMake(((bounds.size.width/2)-offset ) ,bounds.size.height)];
        ...
        case 3:
        {
            [startPath moveToPoint:CGPointMake(offset, 0)];
            
            [startPath addLineToPoint:CGPointMake(bounds.size.width ,0)];
            
            [startPath addLineToPoint:CGPointMake(bounds.size.width, bounds.size.height-offset)];
            
            [startPath addLineToPoint:CGPointMake(offset, bounds.size.height-offset)];
            
            [startPath addLineToPoint:CGPointMake(offset, bounds.size.height/2 + offset-offset)];
            
            [startPath addLineToPoint:CGPointMake(0, (bounds.size.height/2) -offset)];
...
+ (UIBezierPath *)roofTriangleShape:(CGRect)bounds breakPointValue:(CGFloat)breakPoint rowPointValue:(CGFloat)rowPoint{
    ...
    [startPath moveToPoint:CGPointMake(0, bounds.size.height)];
    
    [startPath addLineToPoint:CGPointMake(breakPoint, bounds.size.height)];
    
    [startPath addLineToPoint:CGPointMake(rowPoint, 0)];
    
    [startPath addLineToPoint:CGPointMake(2*rowPoint-breakPoint, bounds.size.height)];
    
    [startPath addLineToPoint:CGPointMake(bounds.size.width, bounds.size.height)];
...
+ (UIBezierPath *)roofMaksTriangleShape:(CGRect)bounds breakPointValue:(CGFloat)breakPoint rowPointValue:(CGFloat)rowPoint{
    ...
    [startPath moveToPoint:CGPointMake(0, breakPoint)];
    
    [startPath addLineToPoint:CGPointMake(breakPoint, breakPoint)];
    
    [startPath addLineToPoint:CGPointMake(rowPoint, 0)];
    
    [startPath addLineToPoint:CGPointMake(2*rowPoint-breakPoint, breakPoint)];
    
    [startPath addLineToPoint:CGPointMake(bounds.size.width, breakPoint)];
...
+ (UIBezierPath *)whiteSliderTextBgShape:(CGRect)bounds{
    ...
    [path addLineToPoint:CGPointMake(bounds.size.width-30, bounds.size.height)];
...
//+ (UIBezierPath *)circularShape:(CGRect)originalFrame withIndex:(NSInteger)index
//{
//    
//    UIBezierPath *cirularPath = [UIBezierPath bezierPathWithArcCenter: CGPointMake(CGRectGetMidX(originalFrame), CGRectGetMidY(originalFrame))
//                                                               radius:(CGRectGetWidth(originalFrame))/2
//                                                           startAngle:DEGREES_TO_RADIANS(0 +(index*45))
//                                                             endAngle:DEGREES_TO_RADIANS(360+(index*45))
//                                                            clockwise:YES];
//    
//    return cirularPath;
//}
